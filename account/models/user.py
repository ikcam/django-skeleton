...
class User(AbstractUser):
    ...
    companies = models.ManyToManyField(
        Company, blank=True, through='Colaborator', related_name='+',
    ...
    photo = models.ImageField(
        upload_to='account/users/', blank=True, null=True,
        verbose_name=_("Photo")
    )
    photo_thumb = models.ImageField(
        upload_to='account/users/thumb/', blank=True, null=True,
    ...
    def company_switch(self, company):
        ...
        if (
            ...
            return ('error', _("Invalid company."))
