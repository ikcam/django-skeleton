# Generated by Django 2.0.6 on 2018-06-17 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contenttype', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.ContentType', verbose_name='Content type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_created_set', to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contenttype', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType', verbose_name='Content type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.Company', verbose_name='Company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(verbose_name='Content')),
                ('company', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='core.Company', verbose_name='Company')),
                ('contenttype', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='contenttypes.ContentType', verbose_name='Content type')),
                ('user', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='core.Invoice', verbose_name='Invoice')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='visits', to='core.Link', verbose_name='Link')),
            ],
            options={
                'verbose_name': 'Visit',
